 ...
 * AdminModule back. AuditLogModule added closing the real, previously-
 * unused audit_log table gap — same "no cycle" confirmation: it imports
 * nothing itself. */
@Module({
  imports: [GrowthAuditModule, NpsModule, OnboardingModule, SupportTicketModule, AdminAuthModule, AuthModule, BillingModule, AuditLogModule],
  ...
  providers: [PilotSummaryService, SupportTicketAdminService, AdminTenantService, PlatformHealthService, AdminAccessTokenGuard],
})
